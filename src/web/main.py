...
from src.web.routes import query, expand, save, case, sequences
...
app.include_router(case.router, prefix="/api", tags=["case"])
app.include_router(sequences.router, prefix="/api", tags=["sequences"])
